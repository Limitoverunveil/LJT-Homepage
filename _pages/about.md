...
## Publications
My research has been published in top conferences including EMNLP, ICML, and NeurIPS. Key publications include:
- **On the Universal Truthfulness Hyperplane Inside LLMs** (EMNLP 2024, First author)
- **In-Context Sharpness as Alerts** (ICML 2024)
- **C-Eval** (NeurIPS 2023)
- **Composing Parameter-Efficient Modules** (NeurIPS 2023)
